...
## Switches
set_property PACKAGE_PIN V17 [get_ports MusicFlag]					
set_property IOSTANDARD LVCMOS33 [get_ports MusicFlag]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {bomb}]
set_property IOSTANDARD LVCMOS33 [get_ports {bomb}]
